...
export default function Home() {
  return (
    <div className="font-main">
      ...
      <h1 className="text-xl sm:text-2xl lg:text-3xl ml-4 sm:ml-8 md:ml-12 lg:ml-32 mt-5">
        Courses for you
      </h1>
      <div className="mt-4 mx-4 sm:mx-8 md:mx-12 lg:mx-32 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 grid-flow-row gap-8">
