            ...
            .map((this_course) => ( 
                <div className="font-main">
                    ...
                    <div className="flex flex-row  place-item-center w-8 h-auto mt-5 ">
                        <h1 className=" justify-items-start text-xl sm:text-2xl lg:text-3xl ml-12 sm:ml-18 md:ml-28 lg:ml-24 xl:ml-32 ">
                            Episodes
                        </h1>
                        
                        <Link href={`/course`} className="justify-items-end transition-all duration-300 transform hover:scale-105 border-2 border-main text-main rounded-full hover:text-white hover:bg-gradient-to-r from-main to-sub hover:border-main px-4 py-1 ml-2 mr-1">
                            Add
                        </Link>
                        <Link href={`/course`} className="justify-items-end transition-all duration-300 transform hover:scale-105 border-2 border-main text-main rounded-full hover:text-white hover:bg-gradient-to-r from-main to-sub hover:border-main px-4 py-1 ml-1 mr-1">
                            Edit
                        </Link>
                        <Link href={`/course`} className="justify-items-end transition-all duration-300 transform hover:scale-105 border-2 border-main text-main rounded-full hover:text-white hover:bg-gradient-to-r from-main to-sub hover:border-main px-4 py-1 ml-1 mr-2">
                            Delete
                        </Link>
                    </div>
